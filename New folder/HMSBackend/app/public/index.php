...
/**
 * Hotel Management System API Entry Point
 * Refactored to use proper dependency injection and OOP principles
 */
...
// Initialize service container and bootstrap services
...
try {
    ...
    Route::add('/rooms/status/stats/debug', function () {
        $roomController = new RoomController();
        $roomController->getRoomStatusStatsDebug();
    }, ["get"]);
