...
export const getRoomStatusInfo = (status: RoomStatus): RoomStatusInfo => {
...
export const getRoomStatusIcon = (status: RoomStatus): string => {
...
export const getStatusTransitions = (currentStatus: RoomStatus): RoomStatus[] => {
